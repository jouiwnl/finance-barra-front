...
export default function() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'sinteticos',
      render: (_, record) => (
        <Popover style={{ textDecoration: 'ellipsis' }} content={<PopoverContent sinteticos={record.sinteticos} />} title="Sintéticos">
    ...
    <Content style={{ margin: '0 16px'}}>
      ...
      <div className="site-layout-background" style={{ padding: 16, minHeight: 360 }}>
        ...
        {loadingRegisters ? (
          ...
          <Table columns={columns} dataSource={analiticosFiltered ?? analiticos} rowKey={(row) => row.id} />
        )}
      </div>
